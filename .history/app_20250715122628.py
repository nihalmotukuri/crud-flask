...
@app.route('/update_book/<book_id>/<author_id>')
def update_book(book_id, author_id):
    book = books.find_one({ '_id': ObjectId(book_id) })
    author = authors.find_one({ '_id': ObjectId(book_id) })
    print(book)
    authors = request.form.getlist('authors')
    books.update_one({'_id': ObjectId(id)}, {'$set': {'title': book['title'], 'authors': authors}})
